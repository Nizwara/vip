...
Name=$(curl -sS https://raw.githubusercontent.com/Nizwara/permission/main/ipmini | grep $MYIP | awk '{print $2}')
ipsaya=$(wget -qO- ifconfig.me)
data_server=$(curl -v --insecure --silent https://google.com/ 2>&1 | grep Date | sed -e 's/< Date: //')
date_list=$(date +"%Y-%m-%d" -d "$data_server")
data_ip="https://raw.githubusercontent.com/Nizwara/permission/main/ipmini"
checking_sc() {
...
U2=$(curl -sS https://raw.githubusercontent.com/Nizwara/permission/main/ipmini | grep $MYIP | awk '{print $2}')
U3=$(curl -sS https://raw.githubusercontent.com/Nizwara/permission/main/ipmini | grep $MYIP | awk '{print $3}')
...
madmin=$(curl -sS https://raw.githubusercontent.com/Nizwara/permission/main/ipmini | grep $MYIP | awk '{print $5}')
checking_sc
cd
...
echo "Nizwara" > /etc/github/username
m-ip
fi
}
...
clear;clear;clear
echo -e " $COLOR1╔══════════════════════════════════════════════════════════╗${NC}"
echo -e " $COLOR1║${NC}${COLBG1}               ${WH} • KILLER VPN TUNNELING •                  ${NC}$COLOR1║ $NC"
echo -e " $COLOR1╚══════════════════════════════════════════════════════════╝${NC}"
echo -e " $COLOR1╔══════════════════════════════════════════════════════════╗${NC}"
...
function bannner(){
wget -O /etc/issue.net "https://raw.githubusercontent.com/Nizwara/vip/install/main/issue.net" &> /dev/null
...
cd
rm -rf *
wget https://raw.githubusercontent.com/Nizwara/vip/main/menu/install-up.sh &> /dev/null
