...
echo -e "$COLOR1================================================================================================================${NC}" 
echo -e "$COLOR1=================================================================================================================================================тФА ${WH}BY${NC} ${COLOR1}==${NC}"
...
rm -rf /root/rmbl >/dev/null 
echo -e "$COLOR1тФФ========тФШ${NC}" 
echo -e "$COLOR1тФМ===тФА ${WH}BY${NC} ${COLOR1}===тФАтФАтФАтФР${NC}"
echo -e "$COLOR1 ${NC}             ${WH}=== $author ===${NC}               $COLOR1 $NC"
echo -e "$COLOR1тФФ========тФШ${NC}" 
echo ""
read -n 1 -s -r -p "   Press any key to back on menu"
...
git push -f https://${APIGIT}@github.com/${USERGIT}/permission.git &> /dev/null
clear
echo -e "$COLOR1================================================================================================================================================тФАтФА=${NC}"
echo -e "$COLOR1 ${NC} ${COLBG1}         ${WH}=== DELETE IPVPS ===        ${NC} $COLOR1 $NC"
echo -e "$COLOR1тФФ=========тФАтФШ${NC}"
echo -e "$COLOR1================================================================================================================================================тФА=${NC}"
...
rm -rf /root/rmbl >/dev/null 
echo -e "$COLOR1тФФ=========тФАтФШ${NC}" 
echo -e "$COLOR1тФМ==== ${WH}BY${NC} ${COLOR1}====тФАтФР${NC}"
echo -e "$COLOR1 ${NC}                ${WH}=== $author ===${NC}                 $COLOR1 $NC"
echo -e "$COLOR1тФФ=========тФАтФШ${NC}" 
echo ""
read -n 1 -s -r -p "   Press any key to back on menu"
...
rm -rf /root/rmbl >/dev/null 
echo -e "$COLOR1тФФ========тФШ${NC}" 
echo -e "$COLOR1тФМ=== ${WH}BY${NC} ${COLOR1}===тФАтФАтФАтФР${NC}"
echo -e "$COLOR1 ${NC}       ${WH}=== $author ===${NC}         $COLOR1 $NC"
echo -e "$COLOR1тФФ========тФШ${NC}" 
echo ""
read -n 1 -s -r -p "   Press any key to back on menu"
