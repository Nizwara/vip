...
sldns() {
wget --no-check-certificate https://raw.githubusercontent.com/Nizwara/vip/main/slowdns/installsl.sh && chmod +x installsl.sh && ./installsl.sh
}
res1() {
...
echo -e "$COLOR1└──────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌──────────────────────────────────────────┐${NC}"
echo -e "$COLOR1│  [ 1 ]  \033[1;37mDomain xxx.niswara.me       ${NC}"
echo -e "$COLOR1│  "
echo -e "$COLOR1│  [ 2 ]  \033[1;37mDomain xxx.speedssh.my.id    ${NC}"
echo -e "$COLOR1│  "
echo -e "$COLOR1│  [ 3 ]  \033[1;37mDomain xxx.niswara.tech     ${NC}"
echo -e "$COLOR1│  "
echo -e "$COLOR1└──────────────────────────────────────────┘${NC}"
